...
public class MatrixImageView extends ImageView {
	...
	private OnLongPressLister longPressListener;
	/**  原始X轴位置 */
	private float initX;
	/**  原始Y轴位置 */
	private float initY;
	...
	public void setOnLongPressListener(OnLongPressLister onLongPressLister) {
		this.longPressListener = onLongPressLister;
	}
	@Override
	...
	public class MatrixTouchListener implements OnTouchListener {
		...
		private void checkDragable() {
			...
			//图片右边缘离开右边界，表示不可左移
//			Log.d("mImageWidth*values[Matrix.MSCALE_X]", mImageWidth+":"+values[Matrix.MSCALE_X]+":"+values[Matrix.MTRANS_X]+":"+getWidth());
	...
	private class  GestureListener extends SimpleOnGestureListener {
		...
		public void onShowPress(MotionEvent e) {
			// TODO Auto-generated method stub
			if(longPressListener!=null) longPressListener.onLongPress();
			super.onShowPress(e);
		}
	...
	public interface OnLongPressLister {
