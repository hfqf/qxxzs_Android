...
import com.points.autorepar.adapter.InPurchaseAdapter;
...
public class InAndOutServiceSubListActivity extends BaseActivity {

    public InAndOutServiceSubListActivity() {
    }
    ...
    private InAndOutServiceSubListActivity m_this;
    ...
    private InPurchaseAdapter adapter;
...
//        addBtn.setVisibility(View.INVISIBLE);
        ...
        sortListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(m_this,InPurchaseActivity.class);
        ...
        common_navi_title.setText(getIntent().getStringExtra("name"));
        getAllCompanylist();
    }
    ...
    private  void  getAllCompanylist(){
        ...
        queryAllMap.put("subtype",subid);
        queryAllMap.put("owner",   LoginUserUtil.getTel(InAndOutServiceSubListActivity.this));

        HttpManager.getInstance(InAndOutServiceSubListActivity.this).queryAllContacts("/warehousegoods/query", queryAllMap, new Response.Listener<JSONObject>() {
            @Override
                ...
                if (jsonObject.optInt("code") == 1) {
                    ...
                    if (arr.length() > 0) {
                        ...
                        mainHandler.post(new Runnable() {
                            @Override
                            public void run() {
                                InPurchaseAdapter m_adapter = new InPurchaseAdapter(m_this, list);
