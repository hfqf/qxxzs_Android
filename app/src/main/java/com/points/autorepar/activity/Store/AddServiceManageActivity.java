 ...
 */
public class AddServiceManageActivity extends BaseActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_servicemanage);
...
//需要设置这个 flag 才能调用 setStatusBarColor 来设置状态栏颜色
    ...
    private void   submitBtnClicked(){
        ...
        map.put("owner", LoginUserUtil.getTel(AddServiceManageActivity.this));

        String url = "/warehousesupplier/add";

        if(type == 1)
        {
            url = "/warehousegoodstoptype/add";
        }else{
            url = "/warehousegoodstoptype/update";
            map.put("id", id);
        }
